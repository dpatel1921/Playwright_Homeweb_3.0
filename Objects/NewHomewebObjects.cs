...
{
    public class NewHomewebObjects
    {
        private readonly IPage _page;

        public NewHomewebObjects(IPage page)
        {
            _page = page;
        }
        ...
        public ILocator UserName => _page.Locator("(//input[@name='emailAddress'])[1]");
        ...
        public ILocator Password => _page.Locator("(//input[@name='password'])[1]");

        public ILocator GetStarted1 => _page.Locator("//h2[text()='Mental Health']/following-sibling::a");
        public ILocator ViewAll => _page.Locator("(//a[contains(@class,'link-text-icon end')])[1]");
        public ILocator Wellnes => _page.Locator("//button[normalize-space(text())='WELLNESS']");
        public ILocator Worklife => _page.Locator("//button[normalize-space(text())='WORK-LIFE']");
        public ILocator Sessions => _page.Locator("//span[normalize-space(text())='Sessions']");
        public ILocator Plans => _page.Locator("//span[normalize-space(text())='Plans']");
        public ILocator Categories => _page.Locator("//span[normalize-space(text())='Categories']");
        public ILocator GuidedSupport => _page.Locator("//img[@alt='Image for Guided Support']");
        public ILocator Childcare => _page.Locator("//span[normalize-space(text())='Childcare Resource Locator by LifestageCare']");
        public ILocator HealthRisk => _page.Locator("//span[normalize-space(text())='Health Risk Assessment']");
        public ILocator Sentio1 => _page.Locator("//span[normalize-space(text())='Sentio by Homewood Health']");
        public ILocator DepressionAnxiety => _page.Locator("//p[normalize-space(text())='Depression & Anxiety']");
        public ILocator Foryou => _page.Locator("//span[normalize-space(text())='For You']");
        public ILocator Explore => _page.Locator("//span[normalize-space(text())='Explore']");
        public ILocator DropJourney => _page.Locator("(//a[@class='dropdown-item'])[1]");
        public ILocator DropLib => _page.Locator("(//a[@class='dropdown-item'])[2]");
        public ILocator DropMsg => _page.Locator("(//a[@class='dropdown-item'])[3]");
        public ILocator DropPro => _page.Locator("(//a[@class='dropdown-item'])[4]");
        public ILocator DropFeed => _page.Locator("(//a[@class='dropdown-item'])[5]");
        public ILocator DropTerms => _page.Locator("(//a[@class='dropdown-item'])[6]");
        public ILocator DropPrivacy => _page.Locator("(//a[@class='dropdown-item'])[8]");
        public ILocator DropAbout => _page.Locator("(//a[@class='dropdown-item'])[9]");
        public ILocator GetStarted2 => _page.Locator("//h2[text()='Wellness']/following-sibling::a");
        public ILocator GetStarted3 => _page.Locator("//h2[text()='Work - Life']/following-sibling::a");
        public ILocator QuickAccess1 => _page.Locator("//a[normalize-space(text())='Welcome']");
        public ILocator QuickAccess2 => _page.Locator("//a[normalize-space(text())='Health Snapshot']");
        public ILocator QuickAccess3 => _page.Locator("//a[normalize-space(text())='Welcome to Homewood']");
        public ILocator QuickAccess4 => _page.Locator("//a[normalize-space(text())='Sessions']");
        public ILocator QuickAccess5 => _page.Locator("//a[normalize-space(text())='Services']");
        public ILocator QuickAccess6 => _page.Locator("//a[normalize-space(text())='Active Plans']");

        public ILocator SmartCare => _page.Locator("//a[normalize-space(text())='Launch Smart Care Navigation']");

        public ILocator Journey => _page.Locator("//span[normalize-space(text())='Journey']");
        public ILocator Library => _page.Locator("//span[normalize-space(text())='Library']");
        public ILocator Messages => _page.Locator("//span[normalize-space(text())='Messages']");
        public ILocator Submit => _page.Locator("(//button[@type='submit'])[1]");
        public ILocator Profile => _page.Locator("//span[normalize-space(text())='Open menu']");
        public ILocator ProfileFR => _page.Locator("//button[@aria-label='Basculer le menu du compte']");

        public ILocator Logout => _page.Locator("//button[contains(.,'Sign out')]");
        public ILocator LogoutConfirm => _page.Locator("//a[normalize-space(text())='Sign out']");
        public ILocator LogoutFR => _page.Locator("//span[normalize-space()='Se déconnecter']");
        public ILocator ForgotPassword => _page.Locator("(//label[@class='required']/following-sibling::a)[1]");
        ...
        public ILocator SignupEnbridge => _page.Locator("//button[@title='Register']");
        public ILocator SignupEnbridgeclose => _page.Locator("(//img[@alt='Canada flag'])[2]");
        public ILocator SignupEnbridgeclose1 => _page.Locator("(//img[@alt='Canada flag'])[1]");
        public ILocator SignupEnbridgeFR => _page.Locator("//button[@aria-label=\"S'inscrire\"]");
        public ILocator SignupEnbridgecloseFR => _page.Locator("(//img[@alt='Le drapeau du Canada'])[2]");
        public ILocator SignupEnbridgeclose1FR => _page.Locator("(//img[@alt='Le drapeau du Canada'])[1]");
        public ILocator Signup1 => _page.Locator("a[title='Sign in']");
        public ILocator Signup1Enb => _page.Locator("//button[@aria-label='Sign In']");
        public ILocator Signup1EnbFR => _page.Locator("//button[@aria-label='Se connecter']");
        ...
        public ILocator LanChange => _page.Locator("//span[@class='help-primary']");
        ...
        public ILocator Homewood => _page.Locator("//a[normalize-space()='Contact Us']");
        public ILocator Termsofservice => _page.Locator("a[href='/en/terms-of-service']");
        public ILocator Termsofservicealumni => _page.Locator("//div[@class='auth-form__bottom-links']//a[1]");
        public ILocator Privacypolicy => _page.Locator("a[href='/en/privacy-policy']");
        public ILocator Privacypolicyalumni => _page.Locator("(//div[@class='auth-form__bottom-links']//a)[2]");
        public ILocator Accessibility => _page.Locator("a[href='/en/accessibility']");
        public ILocator HomewoodFR => _page.Locator("//a[normalize-space()='Contactez-nous']");
        ...
        public ILocator CheckinEQ => _page.Locator("//a[normalize-space(text())='Check In']");
        ...
        public ILocator Continue => _page.Locator("//button[normalize-space(text())='Continue']");
        public ILocator ContinueFR => _page.Locator("//button[@type='button'][normalize-space()='Continuer']");
        public ILocator Moodselect => _page.Locator("//label[@for='mood-excited']");

        public ILocator Moodselectcontinue => _page.Locator("//button[normalize-space(text())='Continue']");
        public ILocator BacktoDashboard => _page.Locator("//span[normalize-space(text())='Dashboard']");
        public ILocator BacktoDashboardwellness => _page.Locator("(//span[@class='text'])[1]");
        public ILocator SwitchTheme => _page.Locator("(//button[@class='theme-toggle']//i)[1]");
        public ILocator Switchlan => _page.Locator("//div[@class='auth-form__actions']//a[1]");
        ...
        public ILocator Browse => _page.Locator("//p[normalize-space(text())='About Homewood: Trusted Mental Health Support']");
        ...
        public ILocator Childcarelocator => _page.Locator("//a[normalize-space(text())='Childcare Resource Locator by LifestageCare']");
        ...
        public ILocator HealthandWellness => _page.Locator("//p[normalize-space(text())='Health and Wellness Library']");
        ...
        public ILocator Healthriskassessment => _page.Locator("//a[normalize-space(text())='Health Risk Assessment']");
        ...
        public ILocator Sentio => _page.Locator("//a[normalize-space(text())='Access Sentio']");
        public ILocator SentioFR => _page.Locator("//span[normalize-space()='Sentio par Homewood Santé']");
        public ILocator SentioStart => _page.Locator("//a[normalize-space(text())='Access Sentio']");
        ...
        public ILocator SentioAnxietymoodcomplete => _page.Locator("//span[normalize-space()='Complete']");
        ...
        public ILocator Aboutsentio => _page.Locator("(//A[@href='/en/about'][text()='About Sentio'])[2]");
        public ILocator SentioFAQ => _page.Locator("//A[@href='/en/faq'][text()='FAQs']");
        public ILocator SentioTerms => _page.Locator("(//A[@href='/en/terms'][text()='Terms of Service'])[2]");
        public ILocator SentioPrivacy => _page.Locator("(//A[@href='/en/privacy'][text()='Privacy Policy'])[2]");
        public ILocator SentioAccessibility => _page.Locator("//A[@href='/en/accessibility'][text()='Accessibility']");
        ...
        public ILocator SentioTasksCog2 => _page.Locator("//BUTTON[@type='button'][text()='Select entry']");
        ...
        public ILocator Yourself => _page.Locator("//button[normalize-space(text())='Yourself']");
        ...
        public ILocator SelectTime => _page.Locator("(//button[@class='btn btn-time'])[1]");
        public ILocator SelectMode => _page.Locator("(//button[contains(@class,'btn btn-primary')])[1]");
        public ILocator SelectYes => _page.Locator("(//input[@type='checkbox'])[1]");
        public ILocator SelectYes1 => _page.Locator("//label[normalize-space(text())='I have read and accept the above']");
        public ILocator SelectText => _page.Locator("//label[normalize-space(text())='Text']");
        ...
        public ILocator SelectDashboard => _page.Locator("//a[contains(@class,'btn btn-primary')]");
        ...
        public ILocator ViewDetails => _page.Locator("//a[normalize-space(text())='View Appointment']");
        public ILocator Cancel => _page.Locator("//a[text()=' Reschedule']/following-sibling::button");
        public ILocator CancelYes => _page.Locator("//button[normalize-space(text())='Yes, Cancel Appointment']");
        public ILocator EndServices => _page.Locator("(//a[@class='btn-link'])[1]");
        public ILocator EndServicesFR => _page.Locator("//button[@class='btn-link']");
        public ILocator YesDone => _page.Locator("//button[normalize-space(text())='Yes']");
        public ILocator YesEnd => _page.Locator("//button[@class='btn btn-outline-muted-white btn-booking btn-cancel cancel-confirm']");
        public ILocator Reason => _page.Locator("//label[normalize-space(text())='Not ready.']");
        ...
        public ILocator AlumniFeatured1 => _page.Locator("//p[normalize-space(text())='About Homewood: Trusted Mental Health Support']");
        ...
        public ILocator AlumniFeatured2 => _page.Locator("//p[normalize-space(text())='Personalized Service Recommendations: With Smart Care Navigation']");
